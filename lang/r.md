...
| estimand | character/NULL | `NULL` | The estimand to calculate: `"simple"`, `"cohort"`, `"calendar"`, or `"eventstudy"`. Not case-sensitive. Can be NULL if `A_theta_list` is provided. | One of: "simple", "cohort", "calendar", "eventstudy", or NULL | [verified: R/compute_efficient_estimator_and_se.R#L960] |
...
| return_full_vcv | logical | `FALSE` | If TRUE and estimand = "eventstudy", returns a list with the full variance-covariance matrix for event-study estimates | TRUE/FALSE | [verified: R/compute_efficient_estimator_and_se.R#L966] |
